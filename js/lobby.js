...
import { ZONES } from './zones.js?v=hall250715e';
import { loadProductContent, getMachinesForScene } from './content-store.js?v=hall250715e';
import {
  initMachinePanel,
  ...
  collapseMachineBar,
  buildMachineMarkers,
} from './machine-panel.js?v=hall250715e';

const MEDIA_VERSION = 'hall250715e';
