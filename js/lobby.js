...
import { ZONES } from './zones.js?v=hall250715f';
import { loadProductContent, getMachinesForScene } from './content-store.js?v=hall250715f';
import {
  initMachinePanel,
  ...
  collapseMachineBar,
  buildMachineMarkers,
} from './machine-panel.js?v=hall250715f';

const MEDIA_VERSION = 'hall250715f';
